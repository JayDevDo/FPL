...
highlightTeamEvents = (tmNm)=>{
	curEvw = gamesOverview.evWndw
	console.log("highlightTeamEvents:\t", tmNm, "curEvw:", curEvw );

	let tmGmArr = $("#eventTable tr[id='" + tmNm + "'] td.evtTeamBlock.evtp-EPL > span.fxtrspan").get() ; 
...
remBGClasses = ()=>{ 
	for( let c=1; c<FPLTeamsFull.length;c++){
		clsNm="bg"+FPLTeamsFull[c].shortNm;
